<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Processes_Reviewers_Enable_Disable.aspx.cs" Inherits="Processes_Reviewers_Enable_Disable" %>
        ...
        <asp:TableRow>
            <asp:TableCell>
                <asp:Table runat="server">
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:Label runat="server" Text=" Enable or disable the website for reviewers." />
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>
